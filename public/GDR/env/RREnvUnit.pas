...
type
  ...
  private
    ...
    FShowOptionisFirst: BOolean;
    FShowOptionState: BOolean;
  ...
  public
    ...
    property ShowOptionisFirst : Boolean read FShowOptionisFirst write FShowOptionisFirst;
    property ShowOptionState : Boolean read FShowOptionState write FShowOptionState;
...
constructor TRREnv.Create(AOwner: TComponent);   //비연동 환경설정 기본값
begin
  inherited;
  ...
  FShowOptionReservationTime := True;
  FShowOptionSymptom := False;
  FShowOptionisFirst := False;
  FShowOptionState := False;
...
begin
  ...
  try
    ...
    FShowOptionReservationTime := ini.ReadBool('ShowOption', 'ReservationTime', False);
    FShowOptionSymptom := ini.ReadBool('ShowOption', 'Symptom', True);
    FShowOptionisFirst := ini.ReadBool('ShowOption', 'isFirst', True);
    FShowOptionState := ini.ReadBool('ShowOption', 'Status', True);
  finally
    FreeAndNil( ini );
  end;
...
begin
  ...
  try
    ...
    ini.WriteBool('ShowOption', 'isFirst', FShowOptionisFirst);
    ini.WriteBool('ShowOption', 'Status', FShowOptionState);
  finally
    FreeAndNil( ini );
  end;
end;
